...
/**
 * Main controller that controls all other controllers. Also contains the main
 * method.
 */
public class Controller {
	...
	/**
	 * Generated key pair for encryption, starts the DataController and starts
	 * the main window.
	 * @throws IOException 
	 */
	...
	public static void receivedFile(int device, String path, LocalTime sendTime) {
		...
		// we only accept gif, png, and jpg as an image, all others will be
		// stores as a normal file
	...
	public static void main(String[] args) {
		try {
			...
			new StartPopup("Already started", "This application is already running.", "Please close it first!").setVisible(true);;
		}
	}
}
