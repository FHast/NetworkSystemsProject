				...
				.addGroup(gl_contentPane.createSequentialGroup().addContainerGap()
						.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING, false)
										.addComponent(lblTop).addComponent(lblDevice).addComponent(lblName)
										.addComponent(txtDevice, GroupLayout.DEFAULT_SIZE, 268, Short.MAX_VALUE)
										.addComponent(txtName))
								.addComponent(btnFinish))
						.addContainerGap(154, Short.MAX_VALUE)));
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane
				.createSequentialGroup().addContainerGap().addComponent(lblTop)
				.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(lblDevice)
				.addPreferredGap(ComponentPlacement.RELATED)
				.addComponent(txtDevice, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
						GroupLayout.PREFERRED_SIZE)
				.addPreferredGap(ComponentPlacement.RELATED).addComponent(lblName)
				.addPreferredGap(ComponentPlacement.RELATED)
				.addComponent(txtName, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
				.addGap(18).addComponent(btnFinish).addContainerGap(99, Short.MAX_VALUE)));
